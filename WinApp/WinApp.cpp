...
void OvrStart()
{
    // Init with invisible flag to be able to get our touch controller input without rendering
    // See: https://forums.oculusvr.com/t5/PCVR-Development/ovr-GetInputState-does-not-return-data/td-p/648087
    ovrInitParams initParams = { ovrInit_RequestVersion | ovrInit_Invisible /*ovrInit_FocusAware*/, OVR_MINOR_VERSION, NULL, 0, 0};
                     ...
                     _In_ int       nCmdShow)
{
    ...
    while (GetMessage(&msg, nullptr, 0, 0))
    {
        ...
        //TODO: use ovr_GetTrackingState to get controller poses
        // TODO: Check if we can get input state when in the background somehow, maybe use a timer or something
    }
